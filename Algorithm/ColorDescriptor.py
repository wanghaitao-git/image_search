...
class ColorDescriptor:
    ...
    def get_histogram(self, image, mask, isCenter):
        # get histogram
    ...
    def describe(self, image):
        ...
        for startX, endX, startY, endY in segments:
            ...
            imageHistogram = self.get_histogram(image, cornerMask, False)
            features.append(imageHistogram)
        # get histogram of center part
        imageHistogram = self.get_histogram(image, ellipseMask, True)
        features.append(imageHistogram)
        # return
        return features
